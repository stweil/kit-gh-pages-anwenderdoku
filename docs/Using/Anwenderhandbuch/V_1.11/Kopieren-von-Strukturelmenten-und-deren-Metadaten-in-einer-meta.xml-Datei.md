...
### Metadaten der Strukturelemente
In diesem Element werden die deskriptiven Metadaten (Monografie, Zeitschriften-Band, ...) gespeichert, die im [Metadateneditor](Metadateneditor---Allgemeines.md) eingegeben wurden. 
...
- [Metadaten der Strukturelemente](Kopieren-von-Strukturelmenten-und-deren-Metadaten-in-einer-meta.xml-Datei.md#metadaten-der-strukturelemente) `DMDLOG_0002`, `DMDLOG_0003`, `DMDLOG_0004`, ... 
- [Strukturelemente](Kopieren-von-Strukturelmenten-und-deren-Metadaten-in-einer-meta.xml-Datei.md#strukturelemente-structmap--typelogical)
 `<structMap> / LOGICAL` 
